...
ItemCircle::ItemCircle(const std::string &_name,
    ...
    , show(_name + ".show", QMetaEnum::fromType<Circle::ShowCircleType>(), _show)
    ...
    , showWire(_name + ".showWire", QMetaEnum::fromType<Circle::ShowCircleWireType>(), _showWire)
...
ItemCircleCamera::ItemCircleCamera(const std::string &_name,
    ...
    , radius(_name + ".radius", _radius, 0.0f, std::numeric_limits<float>::max())
    , quality(_name + ".quality", _quality)
    , show(_name + ".show", QMetaEnum::fromType<Circle::ShowCircleCameraType>(), _show)
