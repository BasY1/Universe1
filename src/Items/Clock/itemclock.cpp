...
ItemClock::ItemClock(const std::string &_name,
    ...
    , bodyFollowCamera("bodyFollowCamera", _bodyFollowCamera)
    ...
    , materialPlane("materialPlane", _materialPlane)
    , materialTick("materialTick", _materialTick)
    , materialSec("materialSec", _materialSec)
    , materialMin("materialMin", _materialMin)
    , materialHour("materialHour", _materialHour)
{
    addProperty(&time);
    addProperty(&radius);
    addProperty(&quality);
