...
ItemRectangle::ItemRectangle(const std::string &_name,
    ...
    , show(_name + ".show", QMetaEnum::fromType<Rectangle::ShowRectangleType>(), _show)
    , materialFront(_name + ".materialFront", _materialFront)
    , materialBack(_name + ".materialBack", _materialBack)
    , material1Front(_name + ".material1Front", _material1Front)
    , material2Front(_name + ".material2Front", _material2Front)
    , material3Front(_name + ".material3Front", _material3Front)
    , material4Front(_name + ".material4Front", _material4Front)
    , material1Back(_name + ".material1Back", _material1Back)
    , material2Back(_name + ".material2Back", _material2Back)
    , material3Back(_name + ".material3Back", _material3Back)
    , material4Back(_name + ".material4Back", _material4Back)
    , textureImage(_name + ".textureImage", _textureImage)
    , showWire(_name + ".showWire", QMetaEnum::fromType<Rectangle::ShowRectangleWireType>(), _showWire)
...
ItemRectangleCamera::ItemRectangleCamera(const std::string &_name,
    ...
    , show(_name + ".show", QMetaEnum::fromType<Rectangle::ShowRectangleCameraType>(), _show)
    , material(_name + ".material", _material)
    , material1(_name + ".material1", _material1)
    , material2(_name + ".material2", _material2)
    , material3(_name + ".material3", _material3)
    , material4(_name + ".material4", _material4)
    , textureImage(_name + ".textureImage", _textureImage)
    , showWire(_name + ".showWire", QMetaEnum::fromType<Rectangle::ShowRectangleWireType>(), _showWire)
    , radiusWire(_name + ".radiusWire", _radiusWire, 0.0f, std::numeric_limits<float>::max())
    , stepWire(_name + ".stepWire", _stepWire, 0.0f, std::numeric_limits<float>::max())
