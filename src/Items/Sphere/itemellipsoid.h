...
/*! \brief Show ellipsoid cut visible modes */
enum ShowEllipsoidCutType : int
{
    EllipsoidCutInnerOuter,  //!< Single color ellipsoid visible from both inside and outside
    EllipsoidCutOuter,       //!< Single color ellipsoid visible from outside
    EllipsoidCutInner,       //!< Single color ellipsoid visible from inside
};
Q_ENUM_NS(ShowEllipsoidCutType)
...
/*! \brief Dynamic ellipsoid-cut video item */
class ItemEllipsoidCut : public Item3DExt
{
 public:
    Props::ItemPropertyFloat radius1;  //!< Ellipsoid radius along normal direction
    Props::ItemPropertyFloat radius2;  //!< Ellipsoid radius along arm direction
     ...
     * \param _visible Initial value for visible flag
     */
    ItemEllipsoidCut(const std::string &_name = "Ellipsoid",
                     const Math::Vec3F &_center = {},
                     const Math::Vec3F &_normal = Math::Vec3F::unitZ(),
                     const Math::Vec3F &_arm = Math::Vec3F::unitX(),
                     const float _radius1 = 0.4f,
