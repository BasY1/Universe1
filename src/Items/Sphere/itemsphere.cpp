...
ItemSphere::ItemSphere(const std::string &_name,
    ...
    , show(_name + ".show", QMetaEnum::fromType<Sphere::ShowSphereType>(), _show)
    ...
    , showWire(_name + ".showWire", QMetaEnum::fromType<Sphere::ShowSphereWireType>(), _showWire)
    ...
    , qualityLatLong(_name + ".qualityLatLong", _qualityLatLong)
...
ItemSphereCut::ItemSphereCut(const std::string &_name,
    ...
    , quality(_name + ".quality", _quality)
    , show(_name + ".show", QMetaEnum::fromType<Sphere::ShowSphereCutType>(), _show)
    , materialOuter(_name + ".materialOuter", _materialOuter)
    , materialInner(_name + ".materialInner", _materialInner)
{
    addProperty(&radius);
