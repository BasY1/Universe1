...
ItemSpin::ItemSpin(const std::string &_name,
    ...
    , arrowCount(_name + ".arrowCount", _arrowCount)
    ...
    , arrowOffsetLength(_name + ".arrowOffsetLength", _arrowOffsetLength)
    , arrowOffsetAxis(_name + ".arrowOffsetAxis", _arrowOffsetAxis, 0.0f, std::numeric_limits<float>::max())
    , arrowQuality(_name + ".arrowQuality", _arrowQuality)
