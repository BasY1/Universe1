...
class ItemGroupEyeBall : public ItemPropertyGroup
{
 public:
    ...
    inline ItemGroupEyeBall(const std::string &_name, const Data &_data)
        ...
        , radius("radius", _data.radius, 0.0f, std::numeric_limits<float>::max())
        , offsetPupil("offsetPupil", _data.offsetPupil, 0.0f, 0.75f)
        , anglePupil("anglePupil", _data.anglePupil, 0.0f, Math::toRad(45.0f))
        , angleIris("angleIris", _data.angleIris, 0.0f, Math::toRad(90.0f))
        , angleLidUp("angleLidUp", _data.angleLidUp, 0.0f, M_PI)
        , angleLidBottom("angleLidBottom", _data.angleLidBottom, 0.0f, M_PI)
        , offsetLid("offsetLid", _data.offsetLid, 0.01f, 0.1f)
        , offsetLidEdge("offsetLidEdge", _data.offsetLidEdge, 0.01f, 0.2f)
        , quality("quality", _data.quality)
        , materialPupil("materialPupil", _data.materialPupil)
        , materialIris("materialIris", _data.materialIris)
        , materialSclera("materialSclera", _data.materialSclera)
        , materialLid("materialLid", _data.materialLid)
        , materialLidEdge("materialLidEdge", _data.materialLidEdge)
    {
    ...
    inline ItemGroupEyeBall(const std::string &_name,
        ...
        , offsetPupil("offsetPupil", _offsetPupil, 0.0f, 0.75f)
        , anglePupil("anglePupil", _anglePupil, 0.0f, Math::toRad(45.0f))
        , angleIris("angleIris", _angleIris, 0.0f, Math::toRad(90.0f))
        , angleLidUp("angleLidUp", _angleLidUp, 0.0f, M_PI)
        , angleLidBottom("angleLidBottom", _angleLidBottom, 0.0f, M_PI)
        , offsetLid("offsetLid", _offsetLid, 0.01f, 0.1f)
        , offsetLidEdge("offsetLidEdge", _offsetLidEdge, 0.01f, 0.2f)
        , quality("quality", _quality)
        , materialPupil("materialPupil", _materialPupil)
        , materialIris("materialIris", _materialIris)
        , materialSclera("materialSclera", _materialSclera)
        , materialLid("materialLid", _materialLid)
        , materialLidEdge("materialLidEdge", _materialLidEdge)
    {
        setupProperties({&radius,
                         &offsetPupil,
                         &anglePupil,
