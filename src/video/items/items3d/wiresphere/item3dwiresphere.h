#ifndef UNIVERSE1_VIDEO_ITEM3DWIRESPHERE_H
#define UNIVERSE1_VIDEO_ITEM3DWIRESPHERE_H

#include "../arc/item3dlinearcdash.h"

namespace Universe1 {
namespace Video {

/*! \brief 3D wire-frame sphere item */
struct Item3DWireSphere : public Item3DBase
{
    DynamicVec3 center;                 //!< Center point
    DynamicVec3 normal;                 //!< Normal direction (to pole)
    DynamicVec3 arm;                    //!< Arm direction (to equator)
    DynamicValue<float> radiusSphere;   //!< Radius sphere
    DynamicValue<float> radiusLine;     //!< Radius line
     ...
     */
    Item3DWireSphere(const QVector3D &_center,
...
/*! \brief Footage 3D wire-sphere database */
struct DBItem3DWireSphere : public DBItems3D
{
    /*!
     * \brief Constructor
     ...
     */
    DBItem3DWireSphere(const std::string &_footageName, std::list<Item3D *> *_items);

    /*!
     * \brief Add 3D wire-sphere item
     * \param _center Initial center point
     * \param _normal Initial normal direction
     * \param _arm Initial arm direction
     * \param _radiusSphere Initial radius sphere
     ...
     * \return Created item
     */
    Item3DWireSphere *add(const QVector3D &_center,
                          const QVector3D &_normal,
                          const QVector3D &_arm,
                          const float _radiusSphere,
                          const float _radiusLine,
    ...
    /*!
     * \brief Add visible 3D wire-sphere item
     * \param _center Initial center point
     * \param _normal Initial normal direction
     * \param _arm Initial arm direction
     * \param _radiusSphere Initial radius sphere
     ...
     * \return Created item
     */
    inline Item3DWireSphere *add(const QVector3D &_center,
                                 const QVector3D &_normal,
                                 const QVector3D &_arm,
                                 const float _radiusSphere,
                                 const float _radiusLine,
    ...
    inline Item3DWireSphere *add(const QVector3D &_center,
                                 ...
                                 const Material &_material)
    {
        return add(_center, _normal, _arm, _radiusSphere, Config::cfg().qualityLatLong, _material);
    }

    /*!
     * \brief Add hidden 3D wire-sphere item
     * \param _center Initial center point
     * \param _normal Initial normal direction
     * \param _arm Initial arm direction
     * \param _radiusSphere Initial radius sphere
     ...
     * \return Created item
     */
    inline Item3DWireSphere *addHidden(const QVector3D &_center,
                                       const QVector3D &_normal,
                                       const QVector3D &_arm,
                                       const float _radiusSphere,
                                       const float _radiusLine,
    ...
    inline Item3DWireSphere *addHidden(const QVector3D &_center,
                                       ...
                                       const Material &_material)
    {
        return addHidden(_center, _normal, _arm, _radiusSphere, Config::cfg().qualityLatLong, _material);
    }
};
