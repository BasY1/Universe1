#ifndef UNIVERSE1_VIDEO_ITEM3DLINEARCDASH_H
#define UNIVERSE1_VIDEO_ITEM3DLINEARCDASH_H
...
/*! \brief 3D dash (dash-dot) line arc item */
struct Item3DLineArcDash : public Item3DLineArc
{
     ...
     * \param _countDot Initial dot count (dash-dot pattern)
     ...
     */
    Item3DLineArcDash(const QVector3D &_center,
     ...
     * \param _countDot Dot count (dash-dot pattern)
...
/*! \brief Footage 3D dash arc database */
struct DBItem3DLineArcDash : public DBItems3D
{
    /*!
     * \brief Constructor
     ...
     */
    DBItem3DLineArcDash(const std::string &_footageName, std::list<Item3D *> *_items);

    /*!
     * \brief Add 3D arc dash item
     * \param _center Initial center point
     * \param _normal Initial normal
     * \param _arm Initial arm direction
     * \param _angleDeg Initial arc angle in degrees
     ...
     * \return Created item
     */
    Item3DLineArcDash *add(const QVector3D &_center,
                           const QVector3D &_normal,
                           const QVector3D &_arm,
                           const float _angleDeg,
                           const float _radiusCircle,
    ...
    /*!
     * \brief Add visible 3D arc dash item
     * \param _center Initial center point
     * \param _normal Initial normal
     * \param _arm Initial arm direction
     * \param _angleDeg Initial arc angle in degrees
     ...
     * \return Created item
     */
    inline Item3DLineArcDash *add(const QVector3D &_center,
                                  const QVector3D &_normal,
                                  const QVector3D &_arm,
                                  const float _angleDeg,
                                  const float _radiusCircle,
    ...
    /*!
     * \brief Add hidden 3D arc dash item
     * \param _center Initial center point
     * \param _normal Initial normal
     * \param _arm Initial arm direction
     * \param _angleDeg Initial arc angle in degrees
     ...
     * \return Created item
     */
    inline Item3DLineArcDash *addHidden(const QVector3D &_center,
                                        const QVector3D &_normal,
                                        const QVector3D &_arm,
                                        const float _angleDeg,
                                        const float _radiusCircle,
...
#endif  // UNIVERSE1_VIDEO_ITEM3DLINEARCDASH_H
