#ifndef UNIVERSE1_VIDEO_ITEM3DLINEARCDOTS_H
#define UNIVERSE1_VIDEO_ITEM3DLINEARCDOTS_H
...
/*! \brief 3D dot line arc item */
struct Item3DLineArcDots : public Item3DLineArc
{
     ...
     * \param _multSpace Initial space between dots
     ...
     */
    Item3DLineArcDots(const QVector3D &_center,
...
/*! \brief Footage 3D dots arc database */
struct DBItem3DLineArcDots : public DBItems3D
{
    /*!
     * \brief Constructor
     ...
     */
    DBItem3DLineArcDots(const std::string &_footageName, std::list<Item3D *> *_items);

    /*!
     * \brief Add 3D arc dots item
     * \param _center Initial center point
     * \param _normal Initial normal
     * \param _arm Initial arm direction
     * \param _angleDeg Initial arc angle in degrees
     ...
     * \return Created item
     */
    Item3DLineArcDots *add(const QVector3D &_center,
                           const QVector3D &_normal,
                           const QVector3D &_arm,
                           const float _angleDeg,
                           const float _radiusCircle,
    ...
    /*!
     * \brief Add visible 3D arc dots item
     * \param _center Initial center point
     * \param _normal Initial normal
     * \param _arm Initial arm direction
     * \param _angleDeg Initial arc angle in degrees
     ...
     * \return Created item
     */
    inline Item3DLineArcDots *add(const QVector3D &_center,
                                  const QVector3D &_normal,
                                  const QVector3D &_arm,
                                  const float _angleDeg,
                                  const float _radiusCircle,
    ...
    /*!
     * \brief Add hidden 3D arc dots item
     * \param _center Initial center point
     * \param _normal Initial normal
     * \param _arm Initial arm direction
     * \param _angleDeg Initial arc angle in degrees
     ...
     * \return Created item
     */
    inline Item3DLineArcDots *addHidden(const QVector3D &_center,
                                        const QVector3D &_normal,
                                        const QVector3D &_arm,
                                        const float _angleDeg,
                                        const float _radiusCircle,
