...
Universe1::Video::DynamicMaterialGroup::DynamicMaterialGroup(const QColor _color,
...
{
    setupProps(_allProps, _allMaterials);
}

Universe1::Video::DynamicMaterialGroup::DynamicMaterialGroup(const Material &_material,
                                                             const std::string &_name,
                                                             std::list<DynamicProperty *> &_allProps,
                                                             std::list<DynamicMaterialGroup *> _allMaterials)
