...
void Test_Vec3::testMath()
{
    ...
    using namespace Universe1::Math::Type;
    using namespace Universe1::Math::Const;
    ...
    QVERIFY(Vec3<T>(1, 2, 3).projected(Vec3<T>(5, 0, 0)) == Vec3<T>(1, 0, 0));
    QVERIFY(Vec3<T>(1, 2, 3).projected(Vec3<T>(-5, 0, 0)) == Vec3<T>(1, 0, 0));
    QVERIFY(Vec3<T>(1, 2, 3).projected(Vec3<T>(0, 5, 0)) == Vec3<T>(0, 2, 0));
    QVERIFY(Vec3<T>(1, 2, 3).projected(Vec3<T>(0, -5, 0)) == Vec3<T>(0, 2, 0));
    QVERIFY(Vec3<T>(1, 2, 3).projected(Vec3<T>(0, 0, 5)) == Vec3<T>(0, 0, 3));
    QVERIFY(Vec3<T>(1, 2, 3).projected(Vec3<T>(0, 0, -5)) == Vec3<T>(0, 0, 3));

    QVERIFY(equals<T>(Vec3<T>(1, 2, 3).projectedLength(Vec3<T>(5, 0, 0)), 1));
    QVERIFY(equals<T>(Vec3<T>(1, 2, 3).projectedLength(Vec3<T>(-5, 0, 0)), -1));
    QVERIFY(equals<T>(Vec3<T>(1, 2, 3).projectedLength(Vec3<T>(0, 5, 0)), 2));
    QVERIFY(equals<T>(Vec3<T>(1, 2, 3).projectedLength(Vec3<T>(0, -5, 0)), -2));
    QVERIFY(equals<T>(Vec3<T>(1, 2, 3).projectedLength(Vec3<T>(0, 0, 5)), 3));
    QVERIFY(equals<T>(Vec3<T>(1, 2, 3).projectedLength(Vec3<T>(0, 0, -5)), -3));
}
}  // namespace UnitTest
}  // namespace Universe1
