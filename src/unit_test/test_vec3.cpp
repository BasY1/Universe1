...
Universe1::UnitTest::Test_Vec3::Test_Vec3(QObject *parent)
    : QObject(parent)
{
}

void Universe1::UnitTest::Test_Vec3::initTestCase()
{
...
void Universe1::UnitTest::Test_Vec3::testMathFloat()
{
    testMath<float>();
}
void Universe1::UnitTest::Test_Vec3::testMathDouble()
{
    testMath<double>();
}
void Universe1::UnitTest::Test_Vec3::testMathLongDouble()
{
