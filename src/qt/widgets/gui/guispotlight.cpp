 ...
 */
void Universe1::Widgets::GUI::GuiSpotLight::layoutRow(QGridLayout *_lay, int &_row, const bool _addSingleColor)
{
    ...
    m_cutOffWidgets->layoutRow(tr("Cut-Off"), _lay, _row);
    m_outerCutOffWidgets->layoutRow(tr("Outer cut-Off"), _lay, _row);
