 ...
 */
void Universe1::OpenGL::GLWidget::setSceneAmbientFactor(float _value)
{
 ...
 */
void Universe1::OpenGL::GLWidget::setDirectionLight(const OpenGL::DirectionLight &_directionLight)
{
